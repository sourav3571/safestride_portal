            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        className="fixed bottom-6 right-6 w-16 h-16 rounded-full gradient-bg shadow-glow flex items-center justify-center z-50 hover:scale-110 transition-transform"
                    >
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-6 right-6 w-96 h-[600px] bg-card border rounded-2xl shadow-2xl z-50 flex flex-col overflow-hidden"
                    >
                        {/* Header */}
